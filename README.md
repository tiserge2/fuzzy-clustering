...
where m is any real number greater than 1, u<sub>ij</sub> is the degree of membership of xi in the cluster j, x<sup>i</sup> is the ith of d-dimensional measured data, c<sup>j</sup> is the d-dimension center of the cluster, and ||*|| is any norm expressing the similarity between any measured data and the center.
